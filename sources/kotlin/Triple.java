...
public final class Triple<A, B, C> implements Serializable {
    ...
    public static /* synthetic */ Triple copy$default(Triple triple, A a4, B b4, C c4, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            a4 = triple.first;
        }
        if ((i4 & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return o.a(this.first, triple.first) && o.a(this.second, triple.second) && o.a(this.third, triple.third);
    }
