...
public final class Pair<A, B> implements Serializable {
    ...
    public static /* synthetic */ Pair copy$default(Pair pair, A a4, B b4, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            a4 = pair.first;
        }
        if ((i4 & 2) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        Pair pair = (Pair) obj;
        return o.a(this.first, pair.first) && o.a(this.second, pair.second);
    }
