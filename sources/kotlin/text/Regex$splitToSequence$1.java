...
@d(c = "kotlin.text.Regex$splitToSequence$1", f = "Regex.kt", l = {275, 283, 287}, m = "invokeSuspend")
@Metadata(d1 = {"\u0000\u0010\n\u0002\u0018\u0002\n\u0002\u0010\u000e\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u0002*\b\u0012\u0004\u0012\u00020\u00010\u0000H@¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"LB2/g;", "", "Ll2/q;", "<anonymous>", "(LB2/g;)V"}, k = 3, mv = {1, 9, 0})
final class Regex$splitToSequence$1 extends RestrictedSuspendLambda implements p {
    ...
    Regex$splitToSequence$1(Regex regex, CharSequence charSequence, int i4, c<? super Regex$splitToSequence$1> cVar) {
        super(2, cVar);
        this.this$0 = regex;
    ...
    public final Object invoke(g gVar, c<? super q> cVar) {
        return ((Regex$splitToSequence$1) create(gVar, cVar)).invokeSuspend(q.f14567a);
    }
