...
public class c {
    ...
    private final g f10a = new g();

    /* renamed from: b  reason: collision with root package name */
    private final g f11b = new g();
    ...
    public void e(String str, PropertyValuesHolder[] propertyValuesHolderArr) {
        this.f11b.put(str, propertyValuesHolderArr);
    }
    ...
    public String toString() {
        return 10 + getClass().getName() + '{' + Integer.toHexString(System.identityHashCode(this)) + " timings: " + this.f10a + "}\n";
    }
}
