...
public class AllowList {
    ...
    private static class URLPattern {
        ...
        public URLPattern(java.lang.String r6, java.lang.String r7, java.lang.String r8, java.lang.String r9) {
            /*
                r5 = this;
                r5.<init>()
                r0 = 0
            ...
            L_0x0011:
                ...
                java.util.regex.Pattern r6 = java.util.regex.Pattern.compile(r6, r3)     // Catch:{ NumberFormatException -> 0x008b }
                r5.scheme = r6     // Catch:{ NumberFormatException -> 0x008b }
                goto L_0x001e
            L_0x001c:
                r5.scheme = r2     // Catch:{ NumberFormatException -> 0x008b }
            L_0x001e:
                boolean r6 = r1.equals(r7)     // Catch:{ NumberFormatException -> 0x008b }
                if (r6 == 0) goto L_0x0027
                r5.host = r2     // Catch:{ NumberFormatException -> 0x008b }
                goto L_0x0059
            L_0x0027:
                java.lang.String r6 = "*."
                ...
                java.lang.String r7 = r7.substring(r3)     // Catch:{ NumberFormatException -> 0x008b }
            ...
            L_0x0062:
                ...
                goto L_0x0071
            L_0x006f:
                r5.port = r2     // Catch:{ NumberFormatException -> 0x008b }
            L_0x0071:
            ...
            L_0x007c:
                ...
                goto L_0x008a
            L_0x0088:
                r5.path = r2     // Catch:{ NumberFormatException -> 0x008b }
            L_0x008a:
                return
            L_0x008b:
        ...
        private String regexFromPattern(String str, boolean z3) {
        ...
        public boolean matches(Uri uri) {
            try {
                ...
                LOG.d(AllowList.TAG, e4.toString());
                return false;
            }
        }
    }

    public void addAllowListEntry(String str, boolean z3) {
        String str2 = "*";
        if (this.allowList != null) {
            try {
                ...
                if (matcher.matches()) {
                    ...
                    if (group == null) {
                        this.allowList.add(new URLPattern(Bridge.CAPACITOR_HTTP_SCHEME, str2, group3, group4));
                        this.allowList.add(new URLPattern(Bridge.CAPACITOR_HTTPS_SCHEME, str2, group3, group4));
                        return;
                    }
