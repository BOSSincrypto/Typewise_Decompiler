...
public final class e {
    ...
    private static final String f7149b = m.i("Data");

    /* renamed from: c  reason: collision with root package name */
    public static final e f7150c = new a().a();
    ...
    public static final class a {
        ...
        /* renamed from: a  reason: collision with root package name */
        private Map f7152a = new HashMap();

        public e a() {
            e eVar = new e(this.f7152a);
            e.k(eVar);
            return eVar;
        }
        ...
        public a b(String str, Object obj) {
            if (obj == null) {
                this.f7152a.put(str, (Object) null);
            } else {
                Class<?> cls = obj.getClass();
                if (cls == Boolean.class || cls == Byte.class || cls == Integer.class || cls == Long.class || cls == Float.class || cls == Double.class || cls == String.class || cls == Boolean[].class || cls == Byte[].class || cls == Integer[].class || cls == Long[].class || cls == Float[].class || cls == Double[].class || cls == String[].class) {
                    this.f7152a.put(str, obj);
                } else if (cls == boolean[].class) {
                    this.f7152a.put(str, e.a((boolean[]) obj));
                } else if (cls == byte[].class) {
                    this.f7152a.put(str, e.b((byte[]) obj));
                } else if (cls == int[].class) {
                    this.f7152a.put(str, e.e((int[]) obj));
                } else if (cls == long[].class) {
                    this.f7152a.put(str, e.f((long[]) obj));
                } else if (cls == float[].class) {
                    this.f7152a.put(str, e.d((float[]) obj));
                } else if (cls == double[].class) {
                    this.f7152a.put(str, e.c((double[]) obj));
                } else {
        ...
        public a e(String str, String str2) {
            this.f7152a.put(str, str2);
            return this;
        }
    }

    public e(e eVar) {
        this.f7151a = new HashMap(eVar.f7151a);
    }
    ...
    public static androidx.work.e g(byte[] r7) {
        ...
        L_0x004f:
            ...
            goto L_0x004b
        L_0x0051:
            java.lang.String r4 = f7149b     // Catch:{ all -> 0x002b }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static byte[] k(androidx.work.e r5) {
        /*
            ...
            java.util.Map r5 = r5.f7151a     // Catch:{ IOException -> 0x003e, all -> 0x003b }
        ...
        L_0x006c:
            r5 = move-exception
        L_0x006d:
            java.lang.String r3 = f7149b     // Catch:{ all -> 0x006a }
    ...
    public boolean equals(Object obj) {
        ...
        e eVar = (e) obj;
        Set<String> keySet = this.f7151a.keySet();
        if (!keySet.equals(eVar.f7151a.keySet())) {
            return false;
        }
        for (String str : keySet) {
            Object obj2 = this.f7151a.get(str);
            Object obj3 = eVar.f7151a.get(str);
    ...
    public Map h() {
        return Collections.unmodifiableMap(this.f7151a);
    }

    public int hashCode() {
        return this.f7151a.hashCode() * 31;
    }

    public String i(String str) {
        Object obj = this.f7151a.get(str);
    ...
    public String toString() {
        ...
        if (!this.f7151a.isEmpty()) {
            for (String str : this.f7151a.keySet()) {
                sb.append(str);
                sb.append(" : ");
                Object obj = this.f7151a.get(str);
