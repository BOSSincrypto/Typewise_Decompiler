...
public abstract class c {
    ...
    private static final ThreadLocal f4914a = new ThreadLocal();
    ...
    private static TypedValue c() {
        ThreadLocal threadLocal = f4914a;
    ...
    private static boolean f(Resources resources, int i4) {
        TypedValue c4 = c();
    ...
    private static int g(int i4, float f4, float f5) {
        boolean z3;
        ...
        int b4 = a.b((int) ((((float) Color.alpha(i4)) * f4) + 0.5f), 0, 255);
        if (z3) {
            a c4 = a.c(i4);
            i4 = a.m(c4.j(), c4.i(), f5);
        }
