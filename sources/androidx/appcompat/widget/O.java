...
public abstract class O extends ViewGroup {
    ...
    public void g(Canvas canvas) {
        ...
        for (int i7 = 0; i7 < virtualChildCount; i7++) {
            View s4 = s(i7);
            if (!(s4 == null || s4.getVisibility() == 8 || !t(i7))) {
                a aVar = (a) s4.getLayoutParams();
                if (b4) {
                    i6 = s4.getRight() + aVar.rightMargin;
                } else {
                    i6 = (s4.getLeft() - aVar.leftMargin) - this.f3257l;
                }
                j(canvas, i6);
            }
        }
    ...
    public int getBaseline() {
        ...
        if (childCount > i5) {
            ...
            if (baseline != -1) {
                int i6 = this.f3248c;
                if (this.f3249d == 1 && (i4 = this.f3250e & 112) != 48) {
                    if (i4 == 16) {
                        i6 += ((((getBottom() - getTop()) - getPaddingTop()) - getPaddingBottom()) - this.f3251f) / 2;
                    } else if (i4 == 80) {
                        i6 = ((getBottom() - getTop()) - getPaddingBottom()) - this.f3251f;
                    }
                }
    ...
    public void h(Canvas canvas) {
        ...
        for (int i5 = 0; i5 < virtualChildCount; i5++) {
            ...
            if (!(s4 == null || s4.getVisibility() == 8 || !t(i5))) {
                i(canvas, (s4.getTop() - ((a) s4.getLayoutParams()).topMargin) - this.f3258m);
            }
        }
        if (t(virtualChildCount)) {
            View s5 = s(virtualChildCount - 1);
            if (s5 == null) {
                i4 = (getHeight() - getPaddingBottom()) - this.f3258m;
            } else {
                i4 = s5.getBottom() + ((a) s5.getLayoutParams()).bottomMargin;
            }
            i(canvas, i4);
        }
    }
    ...
    public void i(Canvas canvas, int i4) {
        this.f3256k.setBounds(getPaddingLeft() + this.f3260o, i4, (getWidth() - getPaddingRight()) - this.f3260o, this.f3258m + i4);
        this.f3256k.draw(canvas);
    }

    /* access modifiers changed from: package-private */
    public void j(Canvas canvas, int i4) {
        this.f3256k.setBounds(i4, getPaddingTop() + this.f3260o, this.f3257l + i4, (getHeight() - getPaddingBottom()) - this.f3260o);
        this.f3256k.draw(canvas);
    }
    ...
    public void setDividerDrawable(Drawable drawable) {
        if (drawable != this.f3256k) {
            this.f3256k = drawable;
            boolean z3 = false;
            if (drawable != null) {
                this.f3257l = drawable.getIntrinsicWidth();
                this.f3258m = drawable.getIntrinsicHeight();
            } else {
                this.f3257l = 0;
                this.f3258m = 0;
            }
    ...
    public void setVerticalGravity(int i4) {
        ...
        int i6 = this.f3250e;
        if ((i6 & 112) != i5) {
            this.f3250e = i5 | (i6 & -113);
            requestLayout();
        }
    }

    public void setWeightSum(float f4) {
        this.f3252g = Math.max(0.0f, f4);
    }
    ...
    public void u(int r25, int r26, int r27, int r28) {
        /*
            r24 = this;
            r6 = r24
            boolean r0 = androidx.appcompat.widget.n0.b(r24)
            ...
            boolean r12 = r6.f3246a
            int[] r13 = r6.f3254i
            int[] r14 = r6.f3255j
            int r1 = androidx.core.view.P.B(r24)
            int r1 = androidx.core.view.C0434o.b(r2, r1)
            r15 = 2
            r5 = 1
        ...
        L_0x0082:
            ...
            r4 = r18
            androidx.appcompat.widget.O$a r4 = (androidx.appcompat.widget.O.a) r4
            r18 = r3
    ...
    public void v(int i4, int i5, int i6, int i7) {
        ...
        int i16 = i14 & 8388615;
        if (i15 == 16) {
            i8 = getPaddingTop() + (((i7 - i5) - this.f3251f) / 2);
        } else if (i15 != 80) {
            i8 = getPaddingTop();
        } else {
            i8 = ((getPaddingTop() + i7) - i5) - this.f3251f;
        }
        int i17 = 0;
        while (i17 < virtualChildCount) {
            ...
            if (s4 == null) {
                ...
                a aVar = (a) s4.getLayoutParams();
                int i18 = aVar.gravity;
                if (i18 < 0) {
                    i18 = i16;
                }
                int b4 = C0434o.b(i18, P.B(this)) & 7;
                if (b4 == 1) {
                    i10 = ((paddingRight2 - measuredWidth) / 2) + paddingLeft + aVar.leftMargin;
                    i11 = aVar.rightMargin;
                    i12 = i10 - i11;
                } else if (b4 != 5) {
                    i12 = aVar.leftMargin + paddingLeft;
                } else {
                ...
                int i20 = i8 + aVar.topMargin;
                A(s4, i19, i20 + q(s4), measuredWidth, measuredHeight);
                i17 += p(s4, i17);
                i8 = i20 + measuredHeight + aVar.bottomMargin + r(s4);
                i9 = 1;
                i17 += i9;
            }
            i9 = 1;
    ...
    public void x(int r40, int r41) {
        ...
        L_0x0026:
            ...
            r6[r18] = r5
            r6[r10] = r5
            boolean r4 = r7.f3246a
            boolean r3 = r7.f3253h
        ...
        L_0x009b:
            ...
            r10 = r5
            androidx.appcompat.widget.O$a r10 = (androidx.appcompat.widget.O.a) r10
            float r5 = r10.weight
            float r32 = r0 + r5
    ...
    public void z(int r34, int r35) {
        ...
        L_0x01e7:
            ...
            androidx.appcompat.widget.O$a r11 = (androidx.appcompat.widget.O.a) r11
            int r14 = r7.f3251f
            int r21 = r14 + r9
        ...
        L_0x029b:
            ...
            androidx.appcompat.widget.O$a r14 = (androidx.appcompat.widget.O.a) r14
    ...
    public O(Context context, AttributeSet attributeSet, int i4) {
        ...
        int k4 = v3.k(j.f14955c1, -1);
        if (k4 >= 0) {
            setOrientation(k4);
        }
        int k5 = v3.k(j.f14950b1, -1);
        if (k5 >= 0) {
            setGravity(k5);
        }
        boolean a4 = v3.a(j.f14960d1, true);
        if (!a4) {
            setBaselineAligned(a4);
        }
        this.f3252g = v3.i(j.f14970f1, -1.0f);
        this.f3247b = v3.k(j.f14965e1, -1);
        this.f3253h = v3.a(j.f14985i1, false);
        setDividerDrawable(v3.g(j.f14975g1));
        this.f3259n = v3.k(j.f14990j1, 0);
        this.f3260o = v3.f(j.f14980h1, 0);
        v3.w();
    }
}
