...
public enum WebViewFeatureInternal implements C0654a {
    ...
    private static class a {
        ...
        static final Set f7060a = null;

        static {
            f7060a = new HashSet(Arrays.asList(h.c().a()));
        }
    }
    ...
    public boolean isSupportedByFramework() {
        int i4 = this.mOsVersion;
        if (i4 != -1 && Build.VERSION.SDK_INT >= i4) {
            return true;
        }
        return false;
    }
    ...
    public boolean isSupportedByWebView() {
        return g3.a.b(a.f7060a, this.mInternalFeatureValue);
    }

    private WebViewFeatureInternal(String str, String str2, int i4) {
        this.mPublicFeatureValue = str;
        this.mInternalFeatureValue = str2;
        this.mOsVersion = i4;
    }

    public static boolean isSupported(String str, Collection<C0654a> collection) {
        HashSet<C0654a> hashSet = new HashSet<>();
        for (C0654a next : collection) {
            if (next.getPublicFeatureName().equals(str)) {
                hashSet.add(next);
            }
        }
        if (!hashSet.isEmpty()) {
            for (C0654a isSupported : hashSet) {
