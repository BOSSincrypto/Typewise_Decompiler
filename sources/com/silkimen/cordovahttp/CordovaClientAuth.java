...
class CordovaClientAuth implements Runnable, KeyChainAliasCallback {
    ...
    private void loadFromBuffer() {
        try {
            ...
            Log.e(TAG, "Couldn't load given PKCS12 container for authentication", e4);
    ...
    public void alias(String str) {
        if (str != null) {
            try {
                ...
                Log.e(TAG, "Couldn't load private key and certificate pair with given alias \"" + str + "\" for authentication", e4);
