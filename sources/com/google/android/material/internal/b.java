...
public abstract class b {
    ...
    private static final ThreadLocal f12145a = new ThreadLocal();

    /* renamed from: b  reason: collision with root package name */
    private static final ThreadLocal f12146b = new ThreadLocal();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal threadLocal = f12145a;
        ...
        ThreadLocal threadLocal2 = f12146b;
