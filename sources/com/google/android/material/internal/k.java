...
public abstract class k {
    ...
    private static final Comparator f12163a = new a();
    ...
    private static android.widget.ImageView a(androidx.appcompat.widget.Toolbar r5, android.graphics.drawable.Drawable r6) {
        ...
        L_0x0033:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.material.internal.k.a(androidx.appcompat.widget.Toolbar, android.graphics.drawable.Drawable):android.widget.ImageView");
    }
    ...
    public static TextView c(Toolbar toolbar) {
        List d4 = d(toolbar, toolbar.getSubtitle());
        if (d4.isEmpty()) {
            return null;
        }
        return (TextView) Collections.max(d4, f12163a);
    }
    ...
    public static TextView e(Toolbar toolbar) {
        List d4 = d(toolbar, toolbar.getTitle());
        if (d4.isEmpty()) {
            return null;
        }
        return (TextView) Collections.min(d4, f12163a);
    }
}
