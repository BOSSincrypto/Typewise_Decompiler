...
public class PluginHandle {
    ...
    private PluginHandle(Class<? extends Plugin> cls, Bridge bridge2) {
    ...
    public PluginHandle(Bridge bridge2, Class<? extends Plugin> cls) {
        this(cls, bridge2);
        load();
    }

    public PluginHandle(Bridge bridge2, Plugin plugin) {
