...
public abstract class e {
    ...
    class a extends InputConnectionWrapper {
        ...
        public boolean commitContent(InputContentInfo inputContentInfo, int i4, Bundle bundle) {
            if (this.f590a.a(f.f(inputContentInfo), i4, bundle)) {
                return true;
            }
    ...
    public interface c {
        boolean a(f fVar, int i4, Bundle bundle);
    }
    ...
    static boolean e(java.lang.String r7, android.os.Bundle r8, J.e.c r9) {
        /*
            r0 = 0
        ...
        L_0x0063:
            ...
            J.f r8 = new J.f     // Catch:{ all -> 0x002d }
        ...
        L_0x0082:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: J.e.e(java.lang.String, android.os.Bundle, J.e$c):boolean");
    }

    /* access modifiers changed from: private */
    public static /* synthetic */ boolean f(View view, f fVar, int i4, Bundle bundle) {
        ...
        if (P.e0(view, new C0412d.a(new ClipData(fVar.b(), new ClipData.Item(fVar.a())), 2).d(fVar.c()).b(bundle).a()) == null) {
            return true;
        }
        return false;
    }
