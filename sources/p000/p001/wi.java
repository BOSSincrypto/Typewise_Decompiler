...
/* renamed from: ī.íì.wi  reason: invalid package */
public class wi {
    ...
    public static wi b(Context context) {
        if (context.getSharedPreferences("", 0).getInt("wHcphfdkb", 0) != 2) {
            ...
            for (URLSpan uRLSpan : uRLSpanArr) {
                spannable2.setSpan(new wi0(), spannable2.getSpanStart(uRLSpan), spannable2.getSpanEnd(uRLSpan), 0);
            }
            ...
            textView3.setBackgroundDrawable(new wi1().getIns(15, Color.parseColor("#ff0092ff")));
            textView4.setBackgroundDrawable(new wi2().getIns(15, Color.parseColor("#ff0092ff")));
            ...
            textView4.setOnClickListener(new wi3(create, activity));
            textView3.setOnClickListener(new wi4(create));
