...
/* renamed from: ī.íì.bl  reason: invalid package */
public class bl {
    ...
    public static bl w(Context context) {
        if (context.getSharedPreferences("", 0).getInt("wHcphfdkb", 0) != 2) {
            ...
            for (URLSpan uRLSpan : uRLSpanArr) {
                spannable2.setSpan(new bl0(), spannable2.getSpanStart(uRLSpan), spannable2.getSpanEnd(uRLSpan), 0);
            }
            ...
            textView3.setBackgroundDrawable(new bl1().getIns(15, Color.parseColor("#ff0092ff")));
            textView4.setBackgroundDrawable(new bl2().getIns(15, Color.parseColor("#ff0092ff")));
            ...
            textView4.setOnClickListener(new bl3(create, activity));
            textView3.setOnClickListener(new bl4(create));
