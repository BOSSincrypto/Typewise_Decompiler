...
public class C0943e {
    ...
    private final LinkedHashMap f16419a;
    ...
    public C0943e(int i4) {
        if (i4 > 0) {
            this.f16421c = i4;
            this.f16419a = new LinkedHashMap(0, 0.75f, true);
            return;
        }
    ...
    public final java.lang.Object c(java.lang.Object r5) {
        /*
            ...
            monitor-enter(r4)
            java.util.LinkedHashMap r0 = r4.f16419a     // Catch:{ all -> 0x0013 }
            java.lang.Object r0 = r0.get(r5)     // Catch:{ all -> 0x0013 }
            if (r0 == 0) goto L_0x0015
            int r5 = r4.f16425g     // Catch:{ all -> 0x0013 }
            int r5 = r5 + 1
            r4.f16425g = r5     // Catch:{ all -> 0x0013 }
        ...
        L_0x0013:
            ...
            goto L_0x0054
        L_0x0015:
            int r0 = r4.f16426h     // Catch:{ all -> 0x0013 }
            int r0 = r0 + 1
            r4.f16426h = r0     // Catch:{ all -> 0x0013 }
            monitor-exit(r4)     // Catch:{ all -> 0x0013 }
        ...
        L_0x0024:
            monitor-enter(r4)
            int r1 = r4.f16423e     // Catch:{ all -> 0x0039 }
            int r1 = r1 + 1
            r4.f16423e = r1     // Catch:{ all -> 0x0039 }
            java.util.LinkedHashMap r1 = r4.f16419a     // Catch:{ all -> 0x0039 }
            java.lang.Object r1 = r1.put(r5, r0)     // Catch:{ all -> 0x0039 }
            if (r1 == 0) goto L_0x003b
            java.util.LinkedHashMap r2 = r4.f16419a     // Catch:{ all -> 0x0039 }
        ...
        L_0x0039:
            ...
            goto L_0x0052
        L_0x003b:
            int r2 = r4.f16420b     // Catch:{ all -> 0x0039 }
            int r3 = r4.e(r5, r0)     // Catch:{ all -> 0x0039 }
            int r2 = r2 + r3
            r4.f16420b = r2     // Catch:{ all -> 0x0039 }
        L_0x0044:
        ...
        L_0x0056:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: y.C0943e.c(java.lang.Object):java.lang.Object");
    }
    ...
    public final Object d(Object obj, Object obj2) {
        ...
        synchronized (this) {
            try {
                this.f16422d++;
                this.f16420b += e(obj, obj2);
                put = this.f16419a.put(obj, obj2);
                if (put != null) {
                    this.f16420b -= e(obj, put);
                }
            } catch (Throwable th) {
                while (true) {
                    throw th;
    ...
    public void g(int r5) {
        ...
        L_0x0000:
            monitor-enter(r4)
            int r0 = r4.f16420b     // Catch:{ all -> 0x0012 }
            if (r0 < 0) goto L_0x0055
            java.util.LinkedHashMap r0 = r4.f16419a     // Catch:{ all -> 0x0012 }
        ...
        L_0x0021:
            ...
            java.util.LinkedHashMap r2 = r4.f16419a     // Catch:{ all -> 0x0012 }
            r2.remove(r1)     // Catch:{ all -> 0x0012 }
            int r2 = r4.f16420b     // Catch:{ all -> 0x0012 }
            int r3 = r4.e(r1, r0)     // Catch:{ all -> 0x0012 }
            int r2 = r2 - r3
            r4.f16420b = r2     // Catch:{ all -> 0x0012 }
            int r2 = r4.f16424f     // Catch:{ all -> 0x0012 }
            r3 = 1
            int r2 = r2 + r3
            r4.f16424f = r2     // Catch:{ all -> 0x0012 }
        ...
        L_0x0074:
            ...
            throw r5
        */
        throw new UnsupportedOperationException("Method not decompiled: y.C0943e.g(int):void");
    }
    ...
    public final synchronized String toString() {
        ...
        return String.format(Locale.US, "LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new Object[]{Integer.valueOf(this.f16421c), Integer.valueOf(this.f16425g), Integer.valueOf(this.f16426h), Integer.valueOf(i4)});
    }
}
