...
@d(c = "ch.icoaching.wrio.appnomix.controller.SearchController$subscribeToTextChanges$2$1$1$2", f = "SearchController.kt", l = {238}, m = "invokeSuspend")
final class SearchController$subscribeToTextChanges$2$1$1$2 extends SuspendLambda implements p {
    ...
    public SearchController$subscribeToTextChanges$2$1$1$2(SearchController searchController, List<ProductSuggestion> list, c<? super SearchController$subscribeToTextChanges$2$1$1$2> cVar) {
        super(2, cVar);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i4 == 0) {
            f.b(obj);
            g a4 = g.a((g) this.this$0.f9221m.getValue(), false, !this.$productSuggestions.isEmpty(), 1);
        ...
        if (j4 != null) {
            j4.a0(this.$productSuggestions);
        }
        return q.f14567a;
    }

    public final Object invoke(D d4, c<? super q> cVar) {
        return ((SearchController$subscribeToTextChanges$2$1$1$2) create(d4, cVar)).invokeSuspend(q.f14567a);
    }
}
