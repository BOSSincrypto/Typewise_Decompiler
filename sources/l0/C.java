...
public final class C {
    ...
    public /* synthetic */ class a {
        ...
        public static final /* synthetic */ int[] f14431c;

        /* renamed from: d  reason: collision with root package name */
        public static final /* synthetic */ int[] f14432d;
        ...
        static {
            ...
            L_0x00a0:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: l0.C.a.<clinit>():void");
        }
    }
    ...
    public static final int a(BackoffPolicy backoffPolicy) {
        ...
        int i4 = a.f14430b[backoffPolicy.ordinal()];
        if (i4 == 1) {
            return 0;
        }
        if (i4 == 2) {
    ...
    public static final java.util.Set b(byte[] r9) {
        ...
        L_0x001e:
            ...
            androidx.work.b$c r7 = new androidx.work.b$c     // Catch:{ all -> 0x003c }
            java.lang.String r8 = "uri"
            kotlin.jvm.internal.o.d(r5, r8)     // Catch:{ all -> 0x003c }
        ...
        L_0x003c:
            ...
            goto L_0x0048
        L_0x003e:
            l2.q r3 = l2.q.f14567a     // Catch:{ all -> 0x003c }
            s2.C0896b.a(r2, r9)     // Catch:{ IOException -> 0x0046 }
            goto L_0x0051
        L_0x0044:
            r9 = move-exception
            goto L_0x0057
        ...
        L_0x0049:
            r4 = move-exception
            s2.C0896b.a(r2, r3)     // Catch:{ IOException -> 0x0046 }
            throw r4     // Catch:{ IOException -> 0x0046 }
        L_0x004e:
            r2.printStackTrace()     // Catch:{ all -> 0x0044 }
        L_0x0051:
            l2.q r2 = l2.q.f14567a     // Catch:{ all -> 0x0044 }
            s2.C0896b.a(r1, r9)
            return r0
        L_0x0057:
        ...
        L_0x0058:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: l0.C.b(byte[]):java.util.Set");
    }

    public static final BackoffPolicy c(int i4) {
        if (i4 == 0) {
    ...
    public static final NetworkType d(int i4) {
        if (i4 == 0) {
    ...
    public static final OutOfQuotaPolicy e(int i4) {
        if (i4 == 0) {
    ...
    public static final WorkInfo.State f(int i4) {
        if (i4 == 0) {
    ...
    public static final int g(NetworkType networkType) {
        ...
        int i4 = a.f14431c[networkType.ordinal()];
        if (i4 == 1) {
            return 0;
        }
        int i5 = 2;
    ...
    public static final int h(OutOfQuotaPolicy outOfQuotaPolicy) {
        o.e(outOfQuotaPolicy, "policy");
        int i4 = a.f14432d[outOfQuotaPolicy.ordinal()];
        if (i4 == 1) {
            return 0;
        }
        if (i4 == 2) {
    ...
    public static final byte[] i(java.util.Set r4) {
        ...
        L_0x0024:
            ...
            androidx.work.b$c r2 = (androidx.work.b.c) r2     // Catch:{ all -> 0x0043 }
        ...
        L_0x0043:
            ...
            goto L_0x005a
        L_0x0045:
            l2.q r4 = l2.q.f14567a     // Catch:{ all -> 0x0043 }
            r4 = 0
            s2.C0896b.a(r1, r4)     // Catch:{ all -> 0x0058 }
            s2.C0896b.a(r0, r4)
        ...
        L_0x0061:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: l0.C.i(java.util.Set):byte[]");
    }

    public static final int j(WorkInfo.State state) {
        o.e(state, "state");
        switch (a.f14429a[state.ordinal()]) {
            case 1:
                return 0;
            case 2:
                return 1;
